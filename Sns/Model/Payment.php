...
class CosmoCommerce_Sns_Model_Payment extends Mage_Core_Model_Abstract
{
	public $client_id;
	...
	public function pay_get_token( $order_id, $amount,$desc,$access_token,$app_secret )
	{
		...
		return $this->get( 'http://pay.api.weibo.com/test/pay/get_token.json', $params);
