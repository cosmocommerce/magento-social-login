 ...
 * @version 1.0
 */
class CosmoCommerce_Sns_Model_Saeclient  extends Mage_Core_Model_Abstract
{
	/**
	 * 构造函数
	 * 
    ...
    {
        parent::_construct();
        $this->_init('sns/saeclient');
    }
	
	public function setOauth( $akey, $skey, $access_token, $refresh_token = NULL)
	{
		...
		$snsweibo->setKey( $akey , $skey,$access_token, $refresh_token);
